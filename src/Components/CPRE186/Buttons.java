	...
	public void GUI() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						addresses[0] = InetAddress.getByName("192.168.1.183");
						//addresses[1] = InetAddress.getByName("");
						Server.uploadFile(addresses, chosen);
					} catch (Exception e) {
						e.printStackTrace();
					}
					/*
		...
		class AddListenerPlay1 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[1].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
				/*
		...
		class AddListenerPlay2 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[2].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay3 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[3].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay4 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[4].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay5 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[5].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay6 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[6].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay7 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[7].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		class AddListenerPlay8 implements ActionListener {
			public void actionPerformed(ActionEvent event) {
				...
				try {
					Server.playFile(songList[8].getName());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
