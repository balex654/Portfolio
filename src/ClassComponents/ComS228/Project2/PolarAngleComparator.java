...
public class PolarAngleComparator implements Comparator<Point> {
	...
	public int compare(Point p1, Point p2) {
		...
		else if(p1.getX() == referencePoint.getX() && p1.getY() == referencePoint.getY()){
			return -1;
		}
		else if((p1.getX() != referencePoint.getX() || p1.getY() != referencePoint.getY()) && (p2.getX() != referencePoint.getX() || p2.getY() != referencePoint.getY()) && crossProduct(p1, p2) > 0){
			return -1;
		}
		else if((p1.getX() != referencePoint.getX() || p1.getY() != referencePoint.getY()) && (p2.getX() != referencePoint.getX() || p2.getY() != referencePoint.getY()) && crossProduct(p1, p2) == 0 && compareDistance(p1, p2) == -1){
			return -1;
		}
		return 1;
	}
	...
	public int comparePolarAngle(Point p1, Point p2) {
		...
		else if(crossProduct(p1, p2) > 0 || (p1.getX() == referencePoint.getX() && p1.getY() == referencePoint.getY())){
			return -1;
		}
		else{
			return 1;
